...
angular.module('app')
   ...
   */
  .constant('JQ_CONFIG', {
      easyPieChart:   [   '/javascripts/libs/jquery/jquery.easy-pie-chart/dist/jquery.easypiechart.fill.js'],
      sparkline:      [   '/javascripts/libs/jquery/jquery.sparkline/dist/jquery.sparkline.retina.js'],
      plot:           [   '/javascripts/libs/jquery/flot/jquery.flot.js',
                          '/javascripts/libs/jquery/flot/jquery.flot.pie.js', 
                          '/javascripts/libs/jquery/flot/jquery.flot.resize.js',
                          '/javascripts/libs/jquery/flot.tooltip/js/jquery.flot.tooltip.min.js',
                          '/javascripts/libs/jquery/flot.orderbars/js/jquery.flot.orderBars.js',
                          '/javascripts/libs/jquery/flot-spline/js/jquery.flot.spline.min.js'],
      ...
      dataTable:      [   '/javascripts/libs/jquery/datatables/media/js/jquery.dataTables.min.js',
                          '/javascripts/libs/jquery/plugins/integration/bootstrap/3/dataTables.bootstrap.js',
                          '/javascripts/libs/jquery/plugins/integration/bootstrap/3/dataTables.bootstrap.css'],
